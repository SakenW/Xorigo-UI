import React, * as ToastPrimitive from '@radix-ui/react-toast'
    ...
    >
      ...
      <ToastPrimitive.Close
        className={cn(
          ...
          'focus:opacity-100 focus:outline-none focus:ring-2 group-hover:ring-2',
          variant === 'default'
...
const ToastComponent = Toast as ToastComponent
