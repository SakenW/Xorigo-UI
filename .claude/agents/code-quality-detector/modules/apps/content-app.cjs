...
exports.appsContentModule = void 0;
/**
 * Apps 目录内容检测模块
 */
exports.appsContentModule = {
    id: 'content-app',
    name: 'Apps 内容质量检测',
     ...
     * 检查页面元数据
     */
    async checkPageMetadata(filePath, content, results) {
        // 检查是否有 metadata 导出
     ...
     * 检查硬编码路由
     */
    async checkHardcodedRoutes(content, results) {
        // 检测硬编码的路径
     ...
     * 检查组件模式
     */
    async checkComponentPatterns(content, results) {
        // 检测直接导入 API 函数
...
detection_core_1.DetectionSystem.registerModule(exports.appsContentModule);
