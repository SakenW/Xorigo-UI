...
exports.packagesAPIModule = void 0;
/**
 * Packages 目录 API 检测模块
 */
exports.packagesAPIModule = {
    id: 'api-component',
     ...
     * 检查组件 API
     */
    async checkComponentAPI(filePath, content, results) {
     ...
     * 检查基础属性
     */
    async checkBaseProps(content, componentName, results) {
     ...
     * 检查变体系统
     */
    async checkVariantSystem(content, componentName, results) {
        // 检查是否使用了 cva 或变体系统
     ...
     * 检查 forwardRef
     */
    async checkForwardRef(content, componentName, results) {
     ...
     * 检查 displayName
     */
    async checkDisplayName(content, componentName, results) {
     ...
     * 检查类型导出
     */
    async checkTypeExports(content, componentName, results) {
...
detection_core_1.DetectionSystem.registerModule(exports.packagesAPIModule);
