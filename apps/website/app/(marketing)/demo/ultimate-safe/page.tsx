    ...
    <div className="fixed inset-0 pointer-events-none">
      ...
      >
        <div className="relative w-full h-full">
          <div
            className="absolute inset-0 bg-gradient-radial from-purple-500/10 via-purple-500/5 to-transparent"
          />
        </div>
      </div>
    </div>
        ...
        {components.map((component, index) => {
          ...
          return (
            <div
              ...
              style={{
                transform: `translateX(${offset * 100}%) scale(${1 - Math.abs(offset) * 0.3})`,
...
function App() {
  ...
  return (
    <div className="relative bg-gray-900/90 rounded-2xl overflow-hidden border border-purple-500/20 max-w-4xl mx-auto">
      {/* 编辑器头部 */}
...
// 安全的统计数字动画
const SafeCounter = ({ value, suffix = '' }: { value: number; suffix?: string }) => {
      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button className="relative overflow-hidden bg-gradient-to-r from-purple-500 to-cyan-500 text-white px-6 py-2.5 rounded-full font-medium shadow-lg hover:shadow-purple-500/25 transition-all group">
...
// 主组件
export default function UltimateSafeHome() {
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <div
                  className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-purple-500 to-cyan-500 rounded-2xl flex items-center justify-center transform transition-transform duration-300 hover:rotate-180 hover:scale-110"
                >
