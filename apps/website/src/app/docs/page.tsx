...
export const metadata: Metadata = {
  title: 'Xorigo UI 文档 | 完整的开发文档',
  description: '完整的开发文档，帮助你快速上手 Xorigo UI 组件库。包含 API 参考、使用指南和示例代码。',
  keywords: ['Xorigo UI', '文档', 'React', '组件库', 'API 参考'],
  openGraph: {
    title: 'Xorigo UI 文档',
    description: '完整的开发文档，帮助你快速上手 Xorigo UI 组件库',
    type: 'website',
  },
}

// RSC - Server Component (Default)
export default function DocsPage() {
  // 服务端数据获取 - 无需 useState/useEffect
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {components.length} 个组件 · {categories.length} 个分类 · 版本 {metadata.version}
          </p>
        </div>
