...
/**
 * 真实组件预览版 Workbench Gallery 客户端组件
 * 显示真实的 Xorigo UI 组件效果
 */
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-semibold">🎨 组件效果预览</h2>
              <p className="text-sm text-muted-foreground mt-1">
                实时查看 Xorigo UI 组件的真实效果展示
              </p>
            </div>
      ...
      <Card>
        <CardContent className="py-6">
          <div className="text-center text-sm text-muted-foreground">
            <p className="mb-2">
              💡 <strong>提示：</strong>点击组件可以查看不同变体效果，点击操作按钮可以编辑、复制或查看文档
            </p>
            <p>
              🎨 所有组件都基于 Xorigo UI 设计系统，支持完整的主题定制和响应式设计
            </p>
          </div>
        </CardContent>
      </Card>
