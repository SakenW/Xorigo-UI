...
- **📋 故障排除日志** - 记录所有常见问题和解决方案 [查看详情](./docs/TROUBLESHOOTING-LOG.md)
- **🔧 开发指南** - 详细开发规范和最佳实践 [查看详情](./CLAUDE.md)

### 常见问题快速解决
- 🔴 **构建失败** → SVG 数据 URI、循环引用、模块依赖问题
- 🐳 **Docker 问题** → 容器启动、端口冲突、热更新失效
- 📦 **依赖错误** → 包缺失、版本冲突、类型声明问题
- 🎨 **组件异常** → 渲染错误、事件处理、RSC 兼容性
