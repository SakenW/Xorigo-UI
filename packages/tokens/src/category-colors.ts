 ...
 * UI 基础组件配色 - 优雅的靛蓝渐变
 */
export const uiBasicColors: ComponentCategoryColors = {
  primary: '#6366f1',
  secondary: '#8b5cf6',
  accent: '#a78bfa',
 ...
 * 输入控件配色 - 温暖的珊瑚渐变
 */
export const inputsColors: ComponentCategoryColors = {
  primary: '#f43f5e',
  secondary: '#fb7185',
  accent: '#fda4af',
 ...
 * 导航结构配色 - 清新的天蓝渐变
 */
export const navigationColors: ComponentCategoryColors = {
  primary: '#0ea5e9',
  secondary: '#38bdf8',
  accent: '#7dd3fc',
 ...
 * 反馈状态配色 - 自然的翠绿渐变
 */
export const feedbackColors: ComponentCategoryColors = {
  primary: '#10b981',
  secondary: '#34d399',
  accent: '#6ee7b7',
 ...
 * 弹层遮罩配色 - 热情的橙红渐变
 */
export const overlaysColors: ComponentCategoryColors = {
  primary: '#f97316',
  secondary: '#fb923c',
  accent: '#fdba74',
 ...
 * 数据展示配色 - 深邃的宝蓝渐变
 */
export const dataDisplayColors: ComponentCategoryColors = {
  primary: '#3b82f6',
  secondary: '#60a5fa',
  accent: '#93bbfc',
 ...
 * 布局分区配色 - 优雅的粉紫渐变
 */
export const layoutColors: ComponentCategoryColors = {
  primary: '#ec4899',
  secondary: '#f472b6',
  accent: '#f9a8d4',
 ...
 * 图表组件配色 - 温柔的粉橙渐变
 */
export const chartsColors: ComponentCategoryColors = {
  primary: '#fb923c',
  secondary: '#fdba74',
  accent: '#fed7aa',
  glow: 'rgba(251, 146, 60, 0.4)',
 ...
 * 表单容器配色 - 优雅的玫瑰渐变
 */
export const formsColors: ComponentCategoryColors = {
  primary: '#f43f5e',
  secondary: '#fb7185',
  accent: '#fda4af',
  glow: 'rgba(251, 113, 133, 0.4)',
 ...
 * 工具类配色 - 活力的琥珀渐变
 */
export const utilitiesColors: ComponentCategoryColors = {
  primary: '#f59e0b',
  secondary: '#fbbf24',
  accent: '#fcd34d',
 ...
 * 所有组件分类的完整配色方案
 */
export const componentCategoryColors: Record<string, ComponentCategoryColors> = {
  'ui-basic': uiBasicColors,
  'inputs': inputsColors,
  'navigation': navigationColors,
  'feedback': feedbackColors,
  'overlays': overlaysColors,
  'data-display': dataDisplayColors,
  'layout': layoutColors,
  'charts': chartsColors,
  'forms': formsColors,
  'utilities': utilitiesColors,
}

/**
 * 获取指定分类的颜色配置
 */
export function getCategoryColors(categoryId: string): ComponentCategoryColors | null {
  return componentCategoryColors[categoryId] || null
}
...
export function getCategoryIds(): string[] {
  return Object.keys(componentCategoryColors)
}

/**
 * 检查分类是否存在
 */
export function hasCategoryColors(categoryId: string): boolean {
  return categoryId in componentCategoryColors
}
 ...
 * 验证是否为有效的组件分类颜色配置
 */
export function isValidComponentCategoryColors(colors: any): colors is ComponentCategoryColors {
  return (
    colors &&
    typeof colors.primary === 'string' &&
    typeof colors.secondary === 'string' &&
    typeof colors.accent === 'string' &&
    typeof colors.glow === 'string' &&
    typeof colors.gradient === 'string' &&
    typeof colors.hoverGradient === 'string' &&
    typeof colors.selectedGradient === 'string'
  )
}
 ...
 * 获取指定分类的主色调
 */
export function getPrimaryColor(categoryId: string): string | null {
 ...
 * 获取指定分类的渐变色
 */
export function getGradientColor(categoryId: string): string | null {
  const colors = getCategoryColors(categoryId)
 ...
 * 获取指定分类的悬停渐变
 */
export function getHoverGradient(categoryId: string): string | null {
  const colors = getCategoryColors(categoryId)
  return colors?.hoverGradient || null
}