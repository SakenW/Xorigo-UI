 ...
 * 获取组件分类颜色令牌
 */
export { componentCategoryColors, getCategoryColors, getCategoryIds, hasCategoryColors, getPrimaryColor, getGradientColor, getHoverGradient } from './category-colors';
/**
 * 获取令牌转换器实例
 */
