...
interface CommandContextValue {
  ...
  itemRefs: Map<string, React.RefObject<HTMLDivElement | null>>
  registerItemRef: (value: string, ref: React.RefObject<HTMLDivElement | null>) => void
}
...
export const Command = forwardRef<HTMLDivElement, CommandProps>(
  ({ className, value: controlledValue, onValueChange, filter = defaultFilter, children, ...props }, ref) => {
    ...
    const registerItemRef = (itemValue: string, itemRef: React.RefObject<HTMLDivElement | null>) => {
