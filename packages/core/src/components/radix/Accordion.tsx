...
// 复合组件 - 使用函数包装来解决类型问题
const AccordionWithComponents = (props: React.ComponentPropsWithoutRef<typeof AccordionPrimitive.Root>) => {
  return <Accordion {...props} />
}

// 添加子组件属性
AccordionWithComponents.Item = AccordionItem
AccordionWithComponents.Trigger = AccordionTrigger
AccordionWithComponents.Content = AccordionContent

export { AccordionWithComponents as Accordion }
