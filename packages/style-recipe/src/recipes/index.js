 ...
 * 配方映射表
 */
export const recipeMap = officialRecipes.reduce((map, recipe) => {
...
export function searchRecipes(query) {
    ...
    return officialRecipes.filter((recipe) => recipe.name.toLowerCase().includes(lowercaseQuery) ||
 ...
 * 解析配方ID
 */
export function parseRecipeID(id) {
