...
// ============================================================================
// 七轴风格配方系统 (7-Axis Style Recipe System)
// ============================================================================
...
export type AccentHue = string // 色相值，如 'blue', 'cyan', 'purple'
...
// ============================================================================
// 响应级别系统 (Responsiveness Level System)
// ============================================================================
...
export interface ResponseLevelConfig {
  level: ResponseLevel
  description: string
  responsiveAxes: StyleAxis[] // 响应哪些轴的变化
...
export interface CoreTokens {
  colors: {
    neutral: ColorScale
    [key: string]: ColorScale // 色相 scales: cyanScale, purpleScale, etc.
  }
  states: {
    success: ColorScale
    warning: ColorScale
...
export interface ComponentTokens {
  [componentName: string]: {
    [tokenName: string]: string // 只引用 Role 令牌
  }
}
...
export interface ColorScale {
  [key: number]: string // 0-100 或 1-12 等标度
}
