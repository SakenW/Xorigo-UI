# 🎨 Xorigo UI 组件分类系统说明 v2025.11.03

**创建日期**: 2025年11月3日
**版本**: v2025.11.03
**状态**: ✅ 已完成
**最后更新**: 2025年11月6日 (Week 15并发执行完成后状态同步)
**位置**: `/docs/shared/component-classification-system-v2025.11.03.md`
**用途**: 组件分类系统设计理念、使用指南和最佳实践
**关联**: [组件分类定义SSOT](./component-taxonomy-v2025.11.03.yaml)

> **重要说明**：本文档是对 SSOT 文件 `component-taxonomy-v2025.11.03.yaml` 的设计理念阐述和使用指南。所有分类定义以 SSOT 文件为准。
...
#### 3. 目录结构规范
```bash
# 基于 component-taxonomy-v2025.11.03.yaml 的目录结构
packages/ui/src/
...
### 核心文档
- **[组件分类定义 SSOT](./component-taxonomy-v2025.11.03.yaml)** - 完整分类定义
...
- **代码质量评分**: 基于多维度指标
- **性能评估**: 运行时性能自动分析
- **可访问性检测**: WCAG 2.1 AA自动检测
- **最佳实践检查**: 符合Xorigo UI规范
